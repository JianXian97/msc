#Code adapted from https://github.com/Project-MONAI/research-contributions/tree/main/UNETR/BTCV/trainer.py
...
warnings.filterwarnings("ignore", message="the prediction of class ") #HD distance warning ignore
